...
We want you to feel at home and enjoy your stay in this space designed for you! It's important to mention that this apartment is a home, please treat it as you would treat your friend or family's space — we'd really appreciate it if you could review our house rules by accessing this link: https://zafiro-rules.vercel.app/
...
We want you to feel at home and enjoy your stay in this space designed for you! It's important to mention that this apartment is a home, please treat it as you would treat your friend or family's space, we would really appreciate if you can review our house rules by accessing this link: https://zafiro-rules.vercel.app/
...
¡Queremos que te sientas como en casa y disfrutes tu estadía en este espacio diseñado para vos! Es importante mencionar que este apartamento es un hogar, por favor trátalo como tratarías el espacio de tu amigo o familia — te agradeceríamos que revisés nuestras normas de la casa accediendo a este enlace: https://zafiro-rules.vercel.app/
...
Varo & Michi`},{id:`urban-house-rules`,title:`Reglas de la Casa (Español)`,body:`BIENVENIDOS A ZAFIRO PROPERTY MANAGEMENT

NORMAS DE LA CASA A RESPETAR
Aquí hay algunas reglas que solicitamos cumplir. Si tiene alguna pregunta, por favor consulte.

Reglas de estadía:
- Horarios: Entrada (Check-in) 3:00 PM | Salida (Check-out) 11:00 AM.
- Fumado: Prohibido fumar dentro del edificio o en el balcón.
- Energía: Apague los dispositivos cuando no estén en uso.
- Convivencia: Sea silencioso y discreto con sus vecinos.
- Basura: El ducto de basura es solo para residuos convencionales. No introduzca botellas de vidrio.
- Prohibiciones: No se permiten fiestas ni drogas. No se permiten visitas.
- Reciclaje: El centro de reciclaje está en el sótano #1 (S1).
- Toallas: No use las toallas para limpiar suciedad o quitar el maquillaje.
- Seguridad: Cuide las llaves y la tarjeta de acceso.
- Objetos: No arroje objetos en los pasillos, áreas comunes, balcón o ventanas.
- Restricciones legales: La prostitución o el turismo sexual están prohibidos.
- Alcohol: No se permite alcohol en las áreas comunes.
- Fotografía: Se prohíbe el video o fotografía profesional fuera del apartamento.
- Áreas comunes: Las áreas comunes requieren reservación.

¡DISFRUTE SU ESTADÍA!

Directorio de contactos:
- Emergencias: 911 | Policía: 117 | Bomberos: 118
- Persona a cargo: +506 8831 4833
- Taxi Copetico: 2224-7979 | Taxi Alfaro: 2221-8466 | Taxi Aeropuerto: 2221-6865`},{id:`urban-house-rules-en`,title:`House Rules`,body:`WELCOME TO ZAFIRO PROPERTY MANAGEMENT

HOUSE GUIDELINES TO RESPECT
Here are some rules that we ask to apply. If you ever have any question, please ask.

Stay rules:
- Hours: Check in 3:00 PM | Check out 11:00 AM.
- Smoking: No smoking inside the building or balcony.
- Energy: Turn off devices when not in use.
- Neighbors: Be silent and discrete with your neighbours.
- Trash: Trash duct only for conventional waste. No glass bottles.
- Not allowed: Parties or drugs are not allowed. No visits are allowed.
- Recycling: Recycling center is in basement #1 (S1).
- Towels: Do not use towels to remove dirt or make up.
- Security: Take care of the keys and access card.
- Objects: Don't throw objects in hallways, common areas, balcony or windows.
- Legal: Prostitution or sexual tourism is prohibited.
- Alcohol: No alcohol in common areas.
- Photography: Professional video or photography is prohibited outside the apartment.
- Common areas: Common areas require reservation.

ENJOY YOUR STAY!

Contact directory:
- Emergencies: 911 | Police: 117 | Fireman: 118
- Person in charge: +506 8831 4833
- Taxi Copetico: 2224-7979 | Taxi Alfaro: 2221-8466 | Taxi Airport: 2221-6865`},{id:`urban-checkout`,title:`Check Out`,body:`Hello [guest first name], we sincerely hope you had an amazing time during your stay at [listing name]. We wanted to take a moment to express our gratitude and remind you that check-out is today at [checkout time].
...
Con cariño,
Varo y Michi, tus anfitriones.`}]},{id:`qbo`,group:`sanjose`,name:`Qbo Skyhomes`,zone:`San José · Rohrmoser`,owner:`Varo & Michi`,requisitosCheckIn:{resumen:`Enviar correo a recepcion@condominioqbo.com antes de la llegada del huésped.`,detalle:`Datos a incluir: nombres y apellidos, número de documento de identidad o pasaporte, dirección de correo electrónico del huésped principal, y si ocupa espacio de parqueo.`},quickInfo:[[`Check in`,`3:00 PM`],[`Check out`,`11:00 AM`],[`Correo recepción`,`recepcion@condominioqbo.com`],[`WhatsApp caseta`,`NO`],[`Ingreso app`,`NO`]],units:[{id:`u1422`,name:`Apartamento`,num:`1422`,pax:`4`,parqueo:`304`,forms:`NO`,correo:`recepcion@condominioqbo.com`,whatsapp:`NO`,app:`NO`,extra:[[`WiFi`,`JunglyPH / PuraVida`]],checkin:[{id:`u1422-checkin`,title:`Check In Qbo 1422 (Español)`,body:`¡Hola de nuevo! 😊
...
Nombres y apellidos:
[nombre y apellidos del huésped principal]
...
Saludos cordiales,
Zafiro Property Managment`}]},{id:`u23b`,name:`Hermosa Palms Zafiro 23B`,num:`23B`,pax:`6`,parqueo:`2 parqueos o dejar afuera todo bien`,accessCode:`Código de caja: 3287`,forms:`NO`,correo:`NO`,whatsapp:`SI`,app:`NO`,listing:{title:`Hermosa Palms Refuge Beach Front Club House`,url:`https://zafiropm.hostify.club/listing/400013842`,airbnbUrl:`https://www.airbnb.mx/rooms/1019045547334632955`,airbnbTitle:`Gran estudio`,guests:6,bedrooms:3,beds:4,bathrooms:2,description:`Casa "Refugio Hermosa" dentro del Refugio Nacional de Vida Silvestre Playa Hermosa. Habitación principal con cama king, segunda habitación con cama king y balcón, tercera con dos camas individuales (todas con A/C). Sala y cocina de concepto abierto, terraza para comer entre la naturaleza, y acceso al Beach Club con piscina vista al mar y restaurante. Parqueo para 2 vehículos. ⚠️ La lavandería NO es de acceso libre — solo se abre si el huésped la solicita. Cerca: Playa Jacó (15 min), Los Sueños Marina (20 min), Playa Herradura (20 min), Parque Nacional Manuel Antonio (1h15).`,images:[k(`29ecd8f305461b8437ab2d85ce826c88`),k(`a3c33b5f63319b034d25ed210839b6a4`),k(`9f61d33c2a578b7a314d95f75713bd47`),k(`ce0d5b90e907e3f9f6d7979cb6b58850`),k(`922e9a4ea8aaf892b72b873df633e8d8`)]},rooms:[`Habitación 1: Cama king`,`Habitación 2: Cama king`,`Habitación 3: 2 camas individuales`,`2 baños separados de las habitaciones`],extra:[[`Distribución`,`3 habitaciones, 5 camas, 2 baños`],[`Internet`,`CASA 23 / Casahermosa23`],[`Piscina`,`8AM–10PM`]],checkin:[{id:`23b-checkin`,title:`Check In Casa 23B`,body:`Hello
Your arrival is just around the corner and we want to make sure it goes as smoothly as possible. If you have not yet provided the information requested in the previous message, please do so, as without it, entry will not be possible.
...
Saludos cordiales,
Zafiro Property Management`},...Ce()]},{id:`casa-mistica`,group:`jaco`,name:`Casa Mística`,zone:`Jacó · Playa Hermosa (Místico)`,owner:`Jose Alberto`,requisitosCheckIn:{resumen:`Enviar mensaje a la caseta de seguridad antes de las 11AM, y crear el ingreso del huésped en la app ADITUM.`,detalle:`Por WhatsApp: datos de los huéspedes, fechas de la reserva, y número de casa. Además, hay que registrar el ingreso en la app ADITUM para que la caseta lo tenga habilitado.`},quickInfo:[[`Check in`,`3:00 PM`],[`Check out`,`11:00 AM`],[`Early check in`,`Dejar maletas desde 12PM (no pueden entrar a la casa)`],[`Beach club`,`No tiene, hay café cerca de las caballerizas`],[`Puertas`,`Llave física (la dan los guardas)`],[`TV`,`Streaming, sin cable`],[`Parqueos`,`2 vehículos + visitas`],[`Mascotas`,`No se permiten`],[`Visitantes`,`Solo estadías +5 días y con identificación`],[`Check in interno`,`Enviar mensaje con datos de huéspedes, fechas y # casa antes de las 11AM`],[`Parrilla`,`No hay, cocina totalmente equipada`]],publicInfo:{amenities:[`WiFi`,`A/C`,`Piscina`,`Cocina equipada`,`Parqueo gratis`,`TV`,`Agua caliente`,`Vista al lago`,`Lavadora`],note:`La ficha pública de esta propiedad no detalla reglas de la casa; para dudas específicas usar el link de la ficha.`},localExperiences:be,guiaDigital:{url:`https://auditoria.zafiropm.com/g/a52dbe38-b076-45d0-b128-615ea8cddb10`,nota:`Guía digital que recibe el huésped al llegar (dirección con Google Maps, checklist de salida, wifi/keypad, reglas, botón de emergencias 911, link de reseña en Airbnb y link de reserva directa).`,comoLlegar:`https://maps.google.com/maps?daddr=9.5627822318555,-84.576035575269`},units:[{id:`barca5`,name:`Barca 5`,num:`Barca 5`,pax:`8`,note:`Si se agregan huéspedes adicionales después de la primera confirmación de la reserva, el costo puede aumentar.`,parqueo:`Espacio #5 (asignado exclusivamente a Barca 5)`,forms:`NO`,correo:`NO`,whatsapp:`SI`,app:`SI (ADITUM)`,listing:{title:`Mística Lakeside House (Místico)`,url:`https://zafiropm.hostify.club/listing/400030821`,airbnbUrl:`https://www.airbnb.mx/rooms/1420476142534015378`,airbnbTitle:`Casa Lakeside Piscina privada- Playa Hermosa`,guests:8,bedrooms:3,beds:3,bathrooms:2.5,description:`Casa dentro del residencial Místico, frente al lago. 3 habitaciones, cocina completamente equipada, piscina y vista al lago muy tranquila. A pocos minutos de Jacó y Herradura.`,images:[k(`c027856b8bec4f91f299a2a4e97dff72`),k(`8f7483e2eb3743b4a3126cbe7d05e9d1`),k(`ab64a3470e7c82668c64630d0b24fd77`),k(`1ea877f516ca9187aea619b24ce4501a`),k(`5f9d127d02e8d2a37ac79ae799e225b3`)]},rooms:[`Habitación 1: Cama queen`,`Habitación 2: Cama queen`,`Habitación 3: 1 camarote cama queen`,`2.5 baños separados de las habitaciones`],extra:[[`Distribución`,`3 habitaciones, 5 camas, 2.5 baños`],[`WiFi`,`TicoPassCasa5ONU / Jose2024$`],[`KeyPad`,`74742`],[`Nombre Airbnb`,`Casa Lakeside Piscina privada- Playa Hermosa`]]}],messages:[...Se(),{id:`mistica-ingreso`,title:`Check In (Español)`,body:`Muy buenas tardes:
...
¡Disfrutá tu estadía en Villa Verde!`}],comoLlegar:`https://maps.app.goo.gl/KPJS8oMQr49c2tqB6`,listing:{title:`Oasis 1 Near Jaco Beach Spacious Great Value Stay`,url:`https://zafiropm.hostify.club/listing/400041272`,airbnbUrl:`https://www.airbnb.mx/rooms/1642013545896334036`,airbnbTitle:`Escapada Perfecta | Privacidad, Espacio y Confort`,guests:5,bedrooms:2,beds:3,bathrooms:1,description:`Unidad en Villa Verde, Quebrada Ganado, a pocos minutos de Playa Jacó. Áreas amplias, cocina funcional y ambiente privado; buena relación espacio/precio fuera del bullicio de Jacó. Cerca de Jacó (15 min), Herradura (8 min) y Punta Leona (5 min).`,images:[k(`f8f22d01629a5cd32ab3b798bd3d65a9`),k(`62fc73b3857643816b3ce769485b7436`),k(`b7bceb31d81cf975a3fab2479f5b0c92`),k(`43ae2850757036ea0575dbaa33c640a1`),k(`674b5266ae68ef2b7f9226c7330435a4`)]}},{id:`oasis2`,name:`Oasis 2`,num:`2`,pax:`5`,accessCode:`Caja de seguridad (lockbox) cerca de la puerta: código 0502. Deslizar la tapa negra hacia abajo para ver los discos del código, ingresarlo, y jalar el panel frontal para abrir. Adentro está la llave. Al salir: volver a poner la llave, cerrar firme, y revolver los números para bloquearla.`,rooms:[`Habitación 1: Cama queen`,`Habitación 2: Cama queen`,`Sala: Sofá cama`],extra:[[`WiFi`,`Oasis del Pacifico / Casa52026`],[`Dirección`,`Condominio Villa Verde, Quebrada Ganado, Puntarenas`]],checkin:[{id:`oasis2-checkin`,title:`Check In Oasis 2`,body:`Hello,
...
Cualquier cosa que necesités antes o durante tu estadía, estamos para ayudarte.
¡Disfrutá tu estadía en Villa Verde!`}],guiaDigital:{url:`https://auditoria.zafiropm.com/g/8940c5db-dcd9-494c-92f4-c903e8adf035`,nota:`Guía digital de esta unidad.`,comoLlegar:`https://maps.google.com/maps?daddr=9.7146185666351,-84.638650417328`},listing:{title:`Oasis 2 Near Jaco Quiet And Comfortable Apartment`,url:`https://zafiropm.hostify.club/listing/400041273`,airbnbUrl:`https://www.airbnb.mx/rooms/1642467124401607109`,airbnbTitle:`Escapada minutos de Jacó | Paz y confort`,guests:5,bedrooms:2,beds:3,bathrooms:1,description:`Unidad en Villa Verde, Quebrada Ganado, a pocos minutos de Playa Jacó. Áreas amplias, cocina funcional y ambiente privado; buena relación espacio/precio fuera del bullicio de Jacó.`,images:[k(`934c0630e5d9fa70b851dbd82a7f30ae`),k(`d5462e1a225dc78c973910da361afe33`),k(`851f29408ca2cf588edc79b97ac9a77b`),k(`02976134392c17f1b420629206bcfa6d`),k(`5a93580429b886bf6a32f8a5ac0f9716`)]}},{id:`oasis3`,name:`Oasis 3`,num:`3`,pax:`5`,accessCode:`Lockbox cerca de la puerta: código 0503. Deslizar la tapa negra hacia abajo para ver los discos del código, ingresarlo, y jalar el panel frontal para abrir. Adentro está la llave. Al salir: volver a poner la llave, cerrar firme, y revolver los números para bloquearla.`,rooms:[`Habitación 1: Cama queen`,`Habitación 2: Cama queen`,`Sala: Sofá cama`],extra:[[`WiFi`,`Oasis del Pacifico / Casa52026`],[`Dirección`,`Casas Oasis del Pacifico, Villa Verde, Quebrada Ganado, Puntarenas`]],checkin:[{id:`oasis3-checkin`,title:`Check In Oasis 3`,body:`Hello,
...
Cualquier cosa que necesités antes o durante tu estadía, estamos para ayudarte.
¡Disfrutá tu estadía en Villa Verde!`}],comoLlegar:`https://maps.app.goo.gl/KPJS8oMQr49c2tqB6`,listing:{title:`Oasis 3 Best Value Near Jacó Peaceful Stay`,url:`https://zafiropm.hostify.club/listing/400041271`,airbnbUrl:`https://www.airbnb.mx/rooms/1641742453744802368`,airbnbTitle:`Cerca de Jacó | Amplia, privada y relajante`,guests:5,bedrooms:2,beds:3,bathrooms:1,description:`Unidad en Villa Verde, Quebrada Ganado, a pocos minutos de Playa Jacó. Áreas amplias, cocina funcional y ambiente privado; buena relación espacio/precio fuera del bullicio de Jacó.`,images:[k(`c122fcca0e4b8122654d36e954ad0506`),k(`450b840cc7700c73941e433bc08dcdc2`),k(`893cc5c65b1179d8468dd23b39862d7d`),k(`d816e09a4af7136ba8604fd0caffa0b8`),k(`08ff77938f90293294e27fd7ccfdfb3a`)]}},{id:`oasis4`,name:`Oasis 4`,num:`4`,pax:`5`,accessCode:`Lockbox cerca de la puerta: código 0504. Deslizar la tapa negra hacia abajo para ver los discos del código, ingresarlo, y jalar el panel frontal para abrir. Adentro está la llave. Al salir: volver a poner la llave, cerrar firme, y revolver los números para bloquearla.`,extra:[[`WiFi`,`Oasis del Pacifico / Casa52026`],[`Dirección`,`Casas Oasis del Pacifico, Villa Verde, Quebrada Ganado, Puntarenas`],[`Nombre Airbnb`,`Apartamento cerca de Jacó | Espacio y privacidad`]],checkin:[{id:`oasis4-checkin`,title:`Check In Oasis 4`,body:`Hello,
...
Kind regards,
Zafiro Property Management`}],listing:{title:`Casa Malinches 26A Nature Retreat`,url:`https://zafiropm.hostify.club/listing/400041562`,airbnbUrl:`https://www.airbnb.mx/rooms/1663859606938607939`,airbnbTitle:`Casa Malinches | 4BR Relax Stay | Hacienda Pinilla`,guests:8,bedrooms:4,beds:4,bathrooms:4.5,description:`Villa de lujo dentro de Hacienda Pinilla, con habitaciones amplias cada una con baño privado y terraza cubierta indoor-outdoor. Acceso al Beach Club con piscina infinita frente al mar, gimnasio, cancha de golf, tenis y senderos para bicicleta. Cerca de Avellanas y Tamarindo.`,images:[k(`96f1f975078763afd7d15ae2c9264666`),k(`f7e8670c20867bacd21ea7a7531acc80`),k(`e0f82ea212bb6a20f055833ae67303fd`),k(`4043756ff7aa6b1fface6e8a9aae2416`),k(`76e05c0eb33e6fa64a56cc7c22bcfef8`)]},rooms:[`Habitación 1: Cama queen (baño privado)`,`Habitación 2: Cama queen (baño privado)`,`Habitación 3: Cama queen (baño privado)`,`Habitación 4: Cama king (baño privado)`]}]},{id:`casa-providencia`,group:`guanacaste`,name:`Casa Providencia`,zone:`Guanacaste · Hacienda Pinilla (Pinilla)`,owner:`Michelle / Bruno, Varo & Michi, Adriana (coanfitriones)`,note:`Propiedad nueva del portal de Zafiro PM (villa construida en 2026). Códigos de acceso y wifi específicos aún no documentados — usa el mismo procedimiento de check-in que Del Roble y Malinches (misma comunidad, Hacienda Pinilla).`,requisitosCheckIn:{resumen:`Generar y enviar el código QR de acceso a través de la app HAC.`,detalle:`Mismo procedimiento que Del Roble Refuge y Malinches, por estar dentro de la misma comunidad (Hacienda Pinilla). Códigos de acceso y wifi específicos de la casa: pendientes de documentar.`},quickInfo:[[`Check in`,`3:00 PM`],[`Check out`,`11:00 AM`],[`Capacidad`,`22 personas (fijo — según camas, baños y reglas de la comunidad)`],[`Tamaño`,`940 m² (~10,100 pies²)`],[`Parqueo`,`6 vehículos (2 cubiertos, 4 en la entrada)`],[`Ingreso app`,`SI (HAC)`]],publicInfo:{amenities:[`WiFi`,`A/C en toda la casa`,`Piscina privada`,`Cocina totalmente equipada`,`Parqueo gratis`,`Asador`,`Agua caliente en todos los baños`,`Terraza cubierta`],rules:[`No se permiten mascotas.`,`No fumar.`,`No se permiten fiestas ni eventos.`,`Capacidad máxima fija de 22 personas — no se puede exceder (camas, baños y reglas de la comunidad).`,`Comunidad cerrada (Hacienda Pinilla) con entrada controlada.`]},units:[{id:`providencia-main`,name:`Casa Providencia`,num:``,pax:`22`,rooms:[`Habitación 1: 1 cama King (principal)`,`Habitación 2: 2 camas queen`,`Habitación 3: 4 camas queen (2 camarotes)`,`Habitación 4: 2 camas queen`,`Habitación 5: 2 camas queen`,`Habitación 6: 1 cama King`,`Habitación 7: 1 cama King (principal)`],listing:{title:`Villa nueva de 7 recámaras con alberca · Hacienda Pinilla`,url:`https://www.airbnb.mx/rooms/1757383237540886870`,airbnbUrl:`https://www.airbnb.mx/rooms/1757383237540886870`,airbnbTitle:`Villa nueva de 7 recámaras con alberca · Hacienda Pinilla`,guests:22,bedrooms:7,beds:13,bathrooms:7,description:`Villa nueva de 2026 en Hacienda Pinilla, construida para grupos grandes: 7 recámaras, 7 baños, espacio para 22 personas, en 940 m². Cocina completa, aire acondicionado en todas las áreas, agua caliente y asador para largas cenas. Estacionamiento para 6 autos (2 cubiertos). Comunidad cerrada y tranquila, a minutos de las playas y el campo de golf de Pinilla. No se permiten mascotas, no fumar, no fiestas.`,images:[`https://a0.muscache.com/im/pictures/hosting/Hosting-1757383237540886870/original/ec5dae40-00bd-43e3-a95f-31600e68b0b6.jpeg`,`https://a0.muscache.com/im/pictures/hosting/Hosting-1757383237540886870/original/df4b20e7-acd3-42a9-8870-cdb6634ed910.jpeg`,`https://a0.muscache.com/im/pictures/hosting/Hosting-1757383237540886870/original/b32e176e-dc04-4090-9f30-4e37ba47084f.jpeg`,`https://a0.muscache.com/im/pictures/hosting/Hosting-1757383237540886870/original/f5c94462-765d-42b6-830f-f228c5b281c3.jpeg`,`https://a0.muscache.com/im/pictures/hosting/Hosting-1757383237540886870/original/e7c92673-b097-48b3-b2c3-d7d44c218869.jpeg`]}}]},{id:`farmstay`,group:`sanjose`,name:`Heavenly Highlands (FarmStay)`,zone:`San José · Santa Ana / Tabarcia`,owner:`Bruno y Erica`,note:`Propiedad nueva del portal de Zafiro PM. Aún no tiene proceso operativo interno documentado (códigos, wifi, mensajes de check-in) — solo la ficha pública.`,requisitosCheckIn:{resumen:`Sin requisito de formulario, correo o WhatsApp registrado para esta propiedad.`,detalle:`Propiedad nueva — completar este dato apenas se defina el procedimiento interno de check-in.`},quickInfo:[[`Check in`,`3:00 PM`],[`Check out`,`11:00 AM`],[`Acceso`,`Último tramo de camino lastreado, muy empinado — se recomienda SUV`]],publicInfo:{amenities:[`WiFi`,`A/C`,`Chimenea interior/exterior`,`Fogata`,`Horno de pizza`,`Cocina completa`,`Parqueo gratis`,`Self check-in con clave`,`Recomendaciones de niñera`,`Acceso para silla de ruedas`,`Mascota en la propiedad`],rules:[`No mover el mobiliario.`,`No se permiten sustancias ilegales en la propiedad.`,`No se permiten huéspedes no registrados.`,`Prohibido el uso comercial de la propiedad.`,`No publicar fotos en redes sociales que comprometan la privacidad de la propiedad.`,`Ruido mínimo entre 10 pm y 8 am.`,`No fumar en ningún área de la propiedad.`,`Mascotas bienvenidas solo si se acordaron previamente.`,`Respetar los límites de la propiedad — salir de ellos se considera invasión de propiedad privada vecina.`],note:`El camino de acceso es seguro pero angosto y empinado; el último kilómetro no está pavimentado, se recomienda SUV.`},messages:[{id:`farmstay-welcome-es`,title:`Welcome Message (Español)`,body:`¡Hola! 😊
